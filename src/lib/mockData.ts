import type { Incident, Observation, SafetyWalk, CorrectiveAction, SafetyDoc, Area, ComplianceRecord, JSA, HotWorkPermit, Comment, ForkliftInspection, User, Forklift, PredefinedChecklistItem, SafetyWalkChecklistItem, Investigation } from '@/types';
...
export const mockInvestigations: Investigation[] = [
  {
    ...
    events_history: '1. Floor was cleaned by night crew. 2. Water was left pooled in walkway. 3. Morning shift employee walked through area and slipped.',
    lessons_learned: 'Cleaning procedures must include ensuring floors are completely dry. Signage must be used for any wet surface.',
    action_plan: '1. Update cleaning SOP. 2. Purchase additional "Wet Floor" signs. 3. Retrain cleaning crew.',
  ...
  },
  {
    ...
    events_history: '1. Contractor arrived on site. 2. Contractor began welding without a face shield. 3. Contractor experienced a minor flash burn.',
